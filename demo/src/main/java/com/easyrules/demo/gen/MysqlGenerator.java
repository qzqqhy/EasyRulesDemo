package com.easyrules.demo.gen;
...
public class MysqlGenerator {
     ...
     * 包名
     */
    private static final String PACKAGE_NAME = "com.easyrules";
    /**
     * 模块名称
     */
     ...
     * 输出文件的路径
     */
    private static final String OUT_PATH = "/Users/jun/Documents/wordspace/EasyRulesDemo/demo/src/main/java/";
    /**
     * 代码生成者
     */
    private static final String AUTHOR = "liuxiu";
...
//                                .setDbColumnUnderline(true)// 全局下划线命名
                                ...
                                .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                                 .setInclude(new String[] {"sys_er_rules"}) // 需要生成的表
                ...
                // .setControllerMappingHyphenStyle(true)
                        ...
                        new PackageConfig().setModuleName(MODULE_NAME).setParent(PACKAGE_NAME)// 自定义包路径
                                ...
                                .setXml("mapper").setMapper("mapper").setEntity("model")
